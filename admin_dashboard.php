...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="main-content">
            <h2 class="wlc">WELCOME TO THE ADMIN DASHBOARD
                <br>

            </h2>

            <br><br>
            <h2 class="counts">Counts Overview</h2>
            ...
            <section id="employee">
                ...
                <div class="search-container">
                    <input type="text" id="employeeSearch" placeholder="Search by name, ID number, or salary"
            ...
            <section id="equipment">
                ...
                <div class="search-container">
                    <input type="text" id="equipmentSearch" placeholder="Search by item name, category, or status"
            ...
            <section id="operational-bills">
                ...
                <div class="search-container">
                    <input type="text" id="billsSearch" placeholder="Search by month, year, or total"
                        onkeyup="searchBills()">
                </div>
                <table id="billsTable">
                    <thead>
